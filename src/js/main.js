...
if(mouseScroll != undefined && mouseScroll != null) {
  mouseScroll.addEventListener('click', (e) => {
      ...
      window.scrollTo({
        top: welcome.clientHeight - document.querySelector('.header').clientHeight,
        behavior: 'smooth',
      })
    }
  );
...
swiper2.on('slideChange', function (e) {
  ...
  if(exploreBtn != undefined && exploreBtn != null) {
    exploreBtn.setAttribute('href', slides[swiper2.activeIndex].getAttribute('data-explore-link'))
  }
});
